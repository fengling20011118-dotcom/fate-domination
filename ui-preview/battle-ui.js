...
function render(host,options={}){
 ...
 const api={root};
    ...
    root.getElementById('close-settlement-demo')?.addEventListener('click',closeSettlementDemo);
    ...
    settlementDemo?.addEventListener('click',event=>{if(event.target===settlementDemo&&!settlementDemo.classList.contains('victory'))closeSettlementDemo()});
